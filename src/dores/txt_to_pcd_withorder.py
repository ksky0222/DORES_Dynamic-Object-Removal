...
txt_file_path = os.path.join(data_dir, sys.argv[1] + "_dynamic_removed_withorder.txt") 
output_pcd_file = os.path.join(data_dir, sys.argv[1] + "_dynamic_removed_withorder.pcd")  
